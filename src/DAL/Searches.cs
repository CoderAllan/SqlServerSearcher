namespace SQLServerSearcher.DAL
{
	...
	public class Searches : ISearches
	{
        ...
        public List<TableExtendedProperty> FindTableExtendedProperties(string database, string query = null)
        {
		...
		public List<ProcedureExtendedProperty> FindProcedureExtendedProperties(string database, string query = null)
		{
